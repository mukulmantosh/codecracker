 ...
 <!-- Page-Title -->
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <h4 class="page-title">Recovery Practice Exam</h4>
                        <ol class="breadcrumb">
...
$result_collection = $db->selectCollection('results_practice');
                            ...
                            <table id="datatable" class="table table-striped table-bordered">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                           <form action="recover_exam_practice_success.php" method="post">
