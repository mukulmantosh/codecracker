...
$previous_month= date("n", strtotime("first day of previous month"));
$previous_month = intval($previous_month);
$year = date('Y');
$year = intval($year);
$collection= $db->selectCollection('feedback');
$feed_find = $collection->find(array("month" => $previous_month, "year" => $year));
...
$pdf->MultiCell(200,10,"Previous Month Feedbacks Report Generated on: ".$current_date);
...
$pdf->Output('Previous Month Feedback Generated On '.$current_date.'.pdf', 'D');
