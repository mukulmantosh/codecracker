                    ...
                    <div class="col-sm-12">
                        <div class="card-box table-responsive">
                            ...
                            <table id="datatable" class="table table-striped table-bordered">
                                ...
                                <td><a href="edit_ques_practice.php?id=<?php echo base64_encode($ques["_id"]); ?>&category=<?php echo base64_encode($category); ?>&type=<?php echo base64_encode($type); ?>" class="btn btn-primary">Edit</a></td>
                                </tr>
