...
$leaderboard_find = $leaderboard->find(array("userid" => new MongoId($profile['_id'])));
foreach($leaderboard_find as $lead){
	$mcq_total=  $lead['total'];
	 $coding_total= $lead['coding_total'];
}
			...
			<div class="content-page">
				...
				<div class="content">
					<div class="container">
						...
						<div class="row">
							<div class="col-sm-12">
								<h4 class="page-title">Performance Graph</h4>
...
new Chartist.Bar('#distributed-series', {
  labels: ['Coding', 'MCQ'],
  series: [<?php echo $coding_total; ?>, <?php echo $mcq_total; ?>]
}, {
