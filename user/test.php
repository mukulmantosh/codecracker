...
<div class="container">
	<div class="row">
		...
		<div class="col-lg-7">
			...
			<span id="ques_left" style="font-family: 'Audiowide', cursive; font-size: 12px; color:#ff5050;">Total Questions Left:</span>

			<div id="ques_counter" style="font-family: 'Audiowide', cursive; font-size: 15px;color:#ff9900;"></div>
                ...
                <form  method="post" id="f1" name="f1">
                  ...
                  <strong><p style="font-size:20px; color:#09F;"><?php echo nl2br($text[$num]);  ?></p></strong>
                    <input type="radio" value="<?php echo base64_encode(1); ?>" id='radio1_<?php echo $id[$num]; ?>' name='<?php echo $questionnumber[$num]; ?>'/><strong style="font-size:20px;"> <?php echo $option1[$num];?></strong>
                   <br/>
                    <input type="radio" value="<?php echo base64_encode(2); ?>" id='radio1_<?php echo $id[$num]; ?>' name='<?php echo $questionnumber[$num]; ?>'/><strong style="font-size:20px;"> <?php echo $option2[$num];?></strong>
                    <br/>
                    <input type="radio" value="<?php echo base64_encode(3); ?>" id='radio1_<?php echo $id[$num]; ?>' name='<?php echo $questionnumber[$num]; ?>'/><strong style="font-size:20px;"> <?php echo $option3[$num];?></strong>
                    <br/>
                    <input type="radio" value="<?php echo base64_encode(4); ?>" id='radio1_<?php echo $id[$num];?>' name='<?php echo $questionnumber[$num]; ?>'/><strong style="font-size:20px;"> <?php echo $option4[$num];?></strong>
                    <br/>
                    ...
                    <button id='<?php echo $i;?>' class='next btn btn-success' type='button'>Next</button>
						...
						var counter = <?php echo $test["question"]; ?>

						// Display total
						$("#ques_counter").text(counter);
