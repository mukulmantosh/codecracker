...
class SessionManager
{
    ...
    //Expire session after 40 mins in inactivity
    const SESSION_TIMEOUT = 2400;
    //Expire session after 1 hour
    const SESSION_LIFESPAN = 3600;
    //name of the session cookie
    const SESSION_NAME = 'codecracker';
  ...
  $check_expire= time() - SessionManager::SESSION_LIFESPAN ;
   ...
   $query = array(
            ...
            'expired_at' => array('$gte' => $check_expire));
